...
function sumArray(array) {
  ...
  // first element in array to sum onto
  let firstEl = array[0];
  // remaining elements of the array to call on
  let remainingEls = array.slice(1);
  // recursive call to sum the newly reduced array
  return firstEl + sumArray(remainingEls);
}
